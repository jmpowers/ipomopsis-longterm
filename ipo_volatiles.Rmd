...
qual_not_quant <- setdiff(rownames(qual.all), rownames(quant.all)) #TODO figure out why these are here
quant <- quant.all[setdiff(rownames(qual), qual_not_quant), quant_qual]
```
...
## Heatmap of filtered quant integrations
